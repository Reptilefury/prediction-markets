...
class AssetsGenerationListenerTest {
  ...
  void onAssetsGenerationRequested_Success() throws InterruptedException {
    ...
    when(avatarService.generateAndUploadAvatar(userId)).thenReturn(Mono.just("https://avatar.url"));
    ...
    verify(qrCodeService, timeout(2000))
        .generateAndUploadQRCodes(any(), any(), any(), any(), any(), any());
  }
  ...
  void onAssetsGenerationRequested_WithDepositAddresses() throws InterruptedException {
    ...
    Map<String, Object> depositAddresses =
        Map.of(
            "evm_deposit_address",
                java.util.List.of(
  ...
  void onAssetsGenerationRequested_WithUnknownChainId() throws InterruptedException {
    ...
    Map<String, Object> depositAddresses =
        Map.of(
            "evm_deposit_address",
            java.util.List.of(Map.of("chainId", 999999, "contractAddress", "0xunknown")));
  ...
  void onAssetsGenerationRequested_WithMissingSolanaAddress() throws InterruptedException {
    ...
    Map<String, Object> depositAddresses =
        Map.of("solana_deposit_address", Map.of("wrong_key", "solana123"));
  ...
  void onAssetsGenerationRequested_WithEmptyBitcoinAddresses() throws InterruptedException {
    ...
    Map<String, Object> depositAddresses =
        Map.of("bitcoin_deposit_address", Map.of("unrelated_key", "value"));
