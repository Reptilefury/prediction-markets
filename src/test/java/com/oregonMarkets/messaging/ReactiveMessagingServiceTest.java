...
class ReactiveMessagingServiceTest {
  ...
  @Mock private CamelReactiveStreamsService camelReactiveStreamsService;
  ...
  void consumeWalletRequests_Success() {
    try (MockedStatic<CamelReactiveStreams> mockedStatic = mockStatic(CamelReactiveStreams.class)) {
      mockedStatic
          .when(() -> CamelReactiveStreams.get(camelContext))
  ...
  void publishWalletRequest_Success() {
    try (MockedStatic<CamelReactiveStreams> mockedStatic = mockStatic(CamelReactiveStreams.class)) {
      ...
      when(camelReactiveStreamsService.toStream(
              "wallet-creation-requests", "test-request", String.class))
