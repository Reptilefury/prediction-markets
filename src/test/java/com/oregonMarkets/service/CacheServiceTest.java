...
class CacheServiceTest {
  ...
  void set_Success() {
    ...
    StepVerifier.create(cacheService.set("key1", "value1", Duration.ofMinutes(5))).verifyComplete();
  }
  ...
  void get_Success() {
    ...
    StepVerifier.create(cacheService.get("key1")).expectNext("value1").verifyComplete();
  }
  ...
  void get_NotFound() {
    ...
    StepVerifier.create(cacheService.get("key1")).verifyComplete();
  }
  ...
  void get_Failure() {
    ...
    StepVerifier.create(cacheService.get("key1")).expectError(RuntimeException.class).verify();
  }
  ...
  void delete_Success() {
    ...
    StepVerifier.create(cacheService.delete("key1")).expectNext(true).verifyComplete();
  }
  ...
  void delete_NotFound() {
    ...
    StepVerifier.create(cacheService.delete("key1")).expectNext(false).verifyComplete();
  }
  ...
  void delete_Failure() {
    ...
    StepVerifier.create(cacheService.delete("key1")).expectError(RuntimeException.class).verify();
  }
  ...
  void exists_True() {
    ...
    StepVerifier.create(cacheService.exists("key1")).expectNext(true).verifyComplete();
  }
  ...
  void exists_False() {
    ...
    StepVerifier.create(cacheService.exists("key1")).expectNext(false).verifyComplete();
  }
  ...
  void exists_Failure() {
    ...
    StepVerifier.create(cacheService.exists("key1")).expectError(RuntimeException.class).verify();
  }
}
