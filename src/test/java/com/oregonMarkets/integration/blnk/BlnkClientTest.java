...
class BlnkClientTest {
    ...
    void createIdentity_WithValidData_ShouldReturnIdentityId() {
        ...
        StepVerifier.create(blnkClient.createIdentity("user123", "test@example.com", Map.of("key", "value")))
            .expectNext("test-id")
            .verifyComplete();
    }
    ...
    void createBalance_WithValidCurrency_ShouldReturnBalanceId() {
        ...
        StepVerifier.create(blnkClient.createBalance("USD"))
            .expectNext("balance-123")
            .verifyComplete();
    }
