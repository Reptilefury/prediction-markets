...
class KeycloakProvisionListenerTest {
    ...
    @Test
    void onBlnkBalanceCreated_SuccessfulProvisioning_PublishesAssetsEvent() throws InterruptedException {

        BlnkBalanceCreatedEvent event = BlnkBalanceCreatedEvent.builder()
    ...
    void onBlnkBalanceCreated_FailedProvisioning_HandlesGracefully() {
        ...
        verify(eventPublisher, never())
                .publishEvent(any(AssetsGenerationEvent.class));
    }

    @Test
    void onProvisionRequested_LegacyEvent_ProcessesCorrectly() {

        KeycloakProvisionEvent event = KeycloakProvisionEvent.builder()
                .userId(UUID.randomUUID())
                .username("testuser")
        ...
        verify(adminClient, timeout(1000))
                .createUserIfAbsent("testuser", "password123");
    }
