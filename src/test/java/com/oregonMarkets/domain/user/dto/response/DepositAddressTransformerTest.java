...
class DepositAddressTransformerTest {
    ...
    void transform_CompleteDepositAddresses_TransformsCorrectly() {
        Map<String, Object> rawDepositAddresses = Map.of(
            "evm_deposit_address", List.of(
                Map.of(
                    "chainId", 1,
        ...
        UserRegistrationResponse.DepositAddresses result = DepositAddressTransformer.transform(rawDepositAddresses);
        ...
        assertEquals("native-segwit-address", result.getBitcoinDepositAddress().getNativeSegwitAddress());
