...
class AuthRouterConfigTest {
  ...
  @MockBean private Web3RegistrationService web3RegistrationService;
  ...
  @Test
  @Disabled(
      "RouterFunction beans are not properly registered in WebFluxTest context. Requires integration test setup.")
  void register_Success() {
    ...
    when(userRegistrationService.registerUser(
            ...
            any(MagicDIDValidator.MagicUserInfo.class),
            anyString()))
    ...
    webTestClient
        ...
        .jsonPath("$.magicWalletAddress")
        .isEqualTo("0x123")
        .jsonPath("$.referralCode")
        .isEqualTo("REF12345678");
  }
