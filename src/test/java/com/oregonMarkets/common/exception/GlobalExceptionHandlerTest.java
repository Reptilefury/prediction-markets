...
class GlobalExceptionHandlerTest {
    ...
    void handleUserAlreadyExists() {
        ...
        assertEquals("User with email 'User exists' already exists", response.getBody().getError().getMessage());
    }
    ...
    void handleKeycloakAuth() {
        ...
        assertEquals(ResponseCode.KEYCLOAK_AUTH_FAILED.getCode(), response.getBody().getError().getCode());
    }
    ...
    void handleExternalServiceException() {
        ExternalServiceException ex = new ExternalServiceException(ResponseCode.EXTERNAL_SERVICE_ERROR, "TestService", "Service error");
        ...
        assertEquals(ResponseCode.EXTERNAL_SERVICE_ERROR.getCode(), response.getBody().getError().getCode());
    }
    ...
    void handleAuthenticationException_BadCredentials() {
        ...
        assertEquals(ResponseCode.INVALID_CREDENTIALS.getCode(), response.getBody().getError().getCode());
    }
    ...
    void handleDuplicateKeyException_MagicId() {
        ...
        assertEquals(ResponseCode.DUPLICATE_USER.getHttpStatus(), response.getStatusCode());
        assertEquals("User with this Magic ID already exists", response.getBody().getError().getMessage());
    }
    ...
    void handleGeneric() {
        ...
        assertEquals(ResponseCode.INTERNAL_SERVER_ERROR.getCode(), response.getBody().getError().getCode());
