...
class BusinessExceptionTest {
    ...
    void constructor_WithResponseCodeAndMessage() {
        BusinessException exception = new BusinessException(ResponseCode.VALIDATION_ERROR, "Test message");
    ...
    void constructor_WithResponseCodeMessageAndCause() {
        ...
        BusinessException exception = new BusinessException(ResponseCode.INTERNAL_SERVER_ERROR, "Test message", cause);
