...
public class MarketMapper {
    ...
    public Market toEntity(CreateMarketRequest request, Category category, UUID createdBy) {
        ...
        return Market.builder()
                ...
                .viewConfig(request.getViewConfig())
                .featured(false)
                .trending(false)
                .displayPriority(0)
    ...
    public MarketResponse toResponse(Market market) {
        return MarketResponse.builder()
                ...
                .viewTemplateId(market.getViewTemplateId())
                .viewConfig(market.getViewConfig())
                .featuredViewTemplateId(market.getFeaturedViewTemplateId())
                .featuredViewConfig(market.getFeaturedViewConfig())
                .featuredRank(market.getFeaturedRank())
