...
/**
 * Exception for external service integration errors Used for blockchain, payment providers, wallet
 * services, etc.
 */
@Getter
public class ExternalServiceException extends RuntimeException {
  ...
  public ExternalServiceException(
      ResponseCode responseCode, String serviceName, String message, String details) {
    super(message);
    this.responseCode = responseCode;
    this.serviceName = serviceName;
  ...
  public ExternalServiceException(
      ResponseCode responseCode, String serviceName, String message, Throwable cause) {
    super(message, cause);
    this.responseCode = responseCode;
    this.serviceName = serviceName;
