...
public class DepositAddressTransformer {
  ...
  public static UserRegistrationResponse.DepositAddresses transform(
    ...
    List<UserRegistrationResponse.EVMDepositAddress> evmAddresses =
        transformEVMAddresses(
            (List<Map<String, Object>>) rawDepositAddresses.get("evm_deposit_address"));

    UserRegistrationResponse.SolanaDepositAddress solanaAddress =
        transformSolanaAddress(
            (Map<String, Object>) rawDepositAddresses.get("solana_deposit_address"));

    UserRegistrationResponse.BitcoinDepositAddress bitcoinAddress =
        transformBitcoinAddress(
