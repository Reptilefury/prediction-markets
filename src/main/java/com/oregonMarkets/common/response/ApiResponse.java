...
/**
 * Standardized API response wrapper for Oregon Markets Ensures consistent response structure across
 * all endpoints
 */
@Data
@Builder
...
public class ApiResponse<T> {
  ...
  public static <T> ApiResponse<T> success(
      ResponseCode responseCode, String customMessage, T data) {
    return ApiResponse.<T>builder()
        .status(ResponseStatus.SUCCESS)
  ...
  public static <T> ApiResponse<T> error(ResponseCode responseCode, String customMessage) {
    return ApiResponse.<T>builder()
        ...
        .message(customMessage)
        .code(responseCode.getCode())
        .error(ErrorDetails.builder().code(responseCode.getCode()).message(customMessage).build())
        .build();
  }

  /** Create an error response with details */
  public static <T> ApiResponse<T> error(
      ResponseCode responseCode, String customMessage, String details) {
    return ApiResponse.<T>builder()
        .status(ResponseStatus.FAILED)
        .message(customMessage)
        .code(responseCode.getCode())
  ...
  public ResponseEntity<ApiResponse<T>> toResponseEntity() {
    ...
    return ResponseEntity.status(responseCode.getHttpStatus()).body(this);
  }
