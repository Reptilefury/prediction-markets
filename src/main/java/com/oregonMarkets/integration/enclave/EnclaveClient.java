...
public class EnclaveClient {
    ...
    public Mono<EnclaveUDAResponse> createUDA(String userId, String email, String walletAddress, String destinationTokenAddress) {
        log.info("[ENCLAVE UDA] Starting UDA creation flow for user: {}, email: {}, wallet: {}", userId, email, walletAddress);
        ...
        if (destinationTokenAddress == null || destinationTokenAddress.isEmpty()) {
            ...
            return Mono.error(new EnclaveApiException("Destination token address is required for UDA creation"));
        }
        ...
        if (apiKey == null || apiKey.isEmpty()) {
            log.error("[ENCLAVE UDA] CRITICAL ERROR: Enclave API key is not configured. Please set app.enclave.api-key in application configuration");
        ...
        return webClient.post()
            ...
            .flatMap(body -> {
                try {
                    ...
                    EnclaveUDAResponse udaResponse = mapper.treeToValue(dataNode, EnclaveUDAResponse.class);
                    log.info("[ENCLAVE UDA] ✓ Successfully created Enclave UDA for user: {}", userId);
                    log.info("[ENCLAVE UDA] Response details - udaAddress: {}, destinationAddress: {}, status: {}, userId: {}",
                             udaResponse.getUdaAddress(), udaResponse.getDestinationAddress(), udaResponse.getStatus(), udaResponse.getUserId());
            ...
            .doOnError(error -> {
                log.error("[ENCLAVE UDA] ✗ Failed to create UDA for user: {} - Error: {}", userId, error.getMessage());
    ...
    public static class EnclaveUDAResponse {
        ...
        public void setEnclaveId(String enclaveId) { this.enclaveId = enclaveId; }

        public String getOrgId() { return orgId; }
        public void setOrgId(String orgId) { this.orgId = orgId; }

        public int getDestinationChainId() { return destinationChainId; }
        public void setDestinationChainId(int destinationChainId) { this.destinationChainId = destinationChainId; }
        ...
        public Map<String, Object> getDepositAddresses() { return depositAddresses; }
        public void setDepositAddresses(Map<String, Object> depositAddresses) { this.depositAddresses = depositAddresses; }
        ...
        public Map<String, Object> getBridgeSettings() { return bridgeSettings; }
        public void setBridgeSettings(Map<String, Object> bridgeSettings) { this.bridgeSettings = bridgeSettings; }

        public Map<String, Object> getTotalDeposits() { return totalDeposits; }
        public void setTotalDeposits(Map<String, Object> totalDeposits) { this.totalDeposits = totalDeposits; }
