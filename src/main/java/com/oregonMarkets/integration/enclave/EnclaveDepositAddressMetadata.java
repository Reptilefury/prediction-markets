...
/**
 * Metadata structure for Enclave deposit addresses
 * Borrowed from the multi-chain Enclave UDA design
 *
 * Enclave returns deposit addresses as Map<String, Object> containing chain-specific addresses.
...
public class EnclaveDepositAddressMetadata {
    ...
    /**
     * Raw deposit addresses map from Enclave API
     * Structure: { "ethereum": "0x...", "polygon": "0x...", "arbitrum": "0x...", etc }
     */
