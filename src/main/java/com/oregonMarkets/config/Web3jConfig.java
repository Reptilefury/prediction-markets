...
/**
 * Web3j configuration for Polygon blockchain integration
 * Provides Web3j bean for interacting with Polygon network
 */
@Configuration
@Slf4j
public class Web3jConfig {
    ...
    /**
     * Create Web3j bean for Polygon network
     * Defaults to public Polygon RPC endpoint if not configured
     */
    @Bean
    public Web3j web3j() {
